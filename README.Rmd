...
You can install the released version of MetSizeR from [CRAN](https://CRAN.R-project.org) with:
...
All MetSizeR functionality is accessed through a Shiny application, which can be accessed with by running the following command:
