...
MetSizeR <- function() {
  ui <- shiny::navbarPage(
    ...
    shiny::tabPanel(
      ...
      shiny::fluidRow(
        ...
        shiny::column(width = 8,
                      shiny::h4("The", shiny::tags$b("MetSizeR"), " application was developed for metabolomic scientists to estimate the optimal sample size required for a study to achieve a desired false discovery rate. ", shiny::tags$b("MetSizeR"), "can be used with or without pilot data to estimate the sample size required.",
                  align = "center"
               )
        ),
        shiny::column(width = 2),
      ...
      shiny::fluidRow(
        ...
        shiny::column( width = 8,
                ...
                shiny::h4(
                  shiny::tags$ul(
                    shiny::tags$li(shiny::tags$b("MetSizeR Paper:"),
                                   shiny::tags$a(href="https://bmcbioinformatics.biomedcentral.com/articles/10.1186/1471-2105-14-338",
                    ...
                    shiny::tags$li(shiny::tags$b("R package:"),  shiny::tags$a(href="https://CRAN.R-project.org/package=MetSizeR",
                                                          "MetSizeR: A Tool for Estimating Sample Sizes for Metabolomic Experiments (2021).",
                                                          style = "color:black")),
                    shiny::tags$li( shiny::tags$b("Paper on analysis methods:"),
                                    shiny::tags$a(href="http://bmcbioinformatics.biomedcentral.com/articles/10.1186/1471-2105-11-571",
    ...
    shiny::tabPanel(
      ...
      shiny::fluidPage(shiny::sidebarLayout(
        shiny::sidebarPanel(
          shiny::h3(shiny::tags$b("Vary proportion of significant spectral bins or metabolites")),
          shiny::h5(shiny::tags$em("If the expected proportion of significant bins or metabolites in the experiment is unknown, this tab can be used to see the effect of changing this proportion on the sample size needed to achieve a specified FDR.")),
